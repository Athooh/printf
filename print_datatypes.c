	...
	int flags, int width, int precision, int size)
{
	...
	return (handle_write_chars(c, buffer, flags, width, precision, size));
}
	...
	int flags, int width, int precision, int size)
{
	...
	return (print_number(is_negative, k, buffer, flags, width, precision, size));
}
